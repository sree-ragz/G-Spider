import { StatusBar,StyleSheet, useColorScheme, View ,ImageBackground,Text,Image,Dimensions,
        TouchableOpacity,ActivityIndicator,NativeModules, NativeEventEmitter,LayoutAnimation,Platform,UIManager,Animated,PermissionsAndroid} from 'react-native';
import React, { useEffect, useState ,useRef} from 'react';
import { VLCPlayer } from 'react-native-vlc-media-player';
import CameraLabels from './components/cameraLabels';
...
import saveReport from './components/saveData';
...
function AppContent() {
  ...
  const [beforeData, setBeforeData] = useState<number[]>([0,0,0,0,0,0,0]);
  const [afterData, setAfterData] = useState<number[]>([0,0,0,0,0,0,0]);
  // const rtspUrl="rtsp://admin:admin123@192.168.0.105"
  const webSocketUrl="ws://192.168.36.11:8080"
            ...
            <View style={{ flexDirection: "row", gap: 15,borderWidth:1.5,borderColor:'#E7CA55',padding:8,borderRadius:30}}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  // saveReport(beforeData,afterData);
